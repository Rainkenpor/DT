...
exports.GetById = async (req: any, res: any) =>{
    ...
    try{
        ...
        const respOrm = await ormStatus.GetById(id);
...
exports.Create = async (req: any, res: any) =>{
    ...
    try{
        ...
        if( Name && LastName && Age ){
            const respOrm = await ormStatus.Store( Name, LastName, Age );
            if(respOrm.err){
                status = 'Failure', errorCode = respOrm.err.code, message = respOrm.err.messsage, statusCode = enum_.CODE_BAD_REQUEST;
            }else{
...
exports.UpdateById = async (req: any, res: any) =>{
    ...
    try{
        ...
        const Age = req.body.Age;
        if( Name && LastName && Age ){
            const respOrm = await ormStatus.UpdateById( Name, LastName, Age, id );
            if(respOrm.err){
                status = 'Failure', errorCode = respOrm.err.code, message = respOrm.err.messsage, statusCode = enum_.CODE_BAD_REQUEST;
            }else{
...
exports.DeleteById = async (req: any, res: any) =>{
    ...
    try{
        const id = req.params.id;
            const respOrm = await ormStatus.DeleteById(id);
            if(respOrm.err){
                status = 'Failure', errorCode = respOrm.err.code, message = respOrm.err.messsage, statusCode = enum_.CODE_BAD_REQUEST;
            }else{
